...
const FaqList = () => {
    ...
    const columns = [{
        ...
        render: item => {
            return <Link href={`/board/faq/${item.key}`}>{item.title}</Link>
        },
    }, {
        title: '작성일',
        dataIndex: 'createdAt',
    ...
    return (
        <Wrapper>
            ...
            <TableTop>
                ...
                <Space>
                    <Button type="primary" onClick={() => router.push('/board/faq/write')}><PlusSquareOutlined /> FAQ 등록</Button>
                </Space>
            </TableTop>
