...
const NoticeList = () => {
    const data = [{
        ...
        key: '3',
        title: '공지사항을 확인해주세요33333333',
        createdAt: new Date('2021-09-26'),
        state: 'Y'
    }, {
        key: '4',
        title: '루밍 앱 공지사항 1234 44444',
    ...
    const columns = [{
        ...
        render: item => {
            return <Link href={`/board/notice/${item.key}`}>{item.title}</Link>
        },
    }, {
        title: '작성일',
        dataIndex: 'createdAt',
    ...
    return (
        <Wrapper>
            ...
            <TableTop>
                ...
                <Space>
                    <Button type="primary" onClick={() => router.push('/board/notice/write')}><PlusSquareOutlined /> 공지사항 등록</Button>
                </Space>
            </TableTop>
